...
import com.sergey.spring.mvc_hibernate_aop.service.EmployeeService;
...
public class MyController {
    ...
    public String showAllEmployees(Model model) {
        List<Employee> allEmployees = employeeService.getAllEmployees(); //Связь с DAO на получение
    ...
    private String deleteEmployee(@RequestParam("empId") int employeeId) {
